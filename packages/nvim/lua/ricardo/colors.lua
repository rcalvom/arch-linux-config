...
function M.apply()
  ...
  hl("CmpItemMenu", { fg = colors.dim_fg })
  ...
  hl("TelescopePreviewBorder", { fg = colors.dark_blue, bg = colors.bg })
  hl("TelescopePreviewTitle", { fg = colors.bright_fg, bg = colors.dark_blue, bold = true })
  hl("TelescopeResultsNormal", { fg = colors.fg, bg = colors.bg })
  hl("TelescopeResultsBorder", { fg = colors.dark_blue, bg = colors.bg })
  hl("TelescopeResultsTitle", { fg = colors.bright_fg, bg = colors.dark_blue, bold = true })
  ...
  hl("LualineNormalA", { fg = colors.bright_fg, bg = colors.dark_blue, bold = true })
  hl("LualineNormalB", { fg = colors.fg, bg = colors.selection })
  hl("LualineNormalC", { fg = colors.fg, bg = colors.bg })
  hl("LualineInsertA", { fg = colors.selection, bg = colors.green, bold = true })
  hl("LualineVisualA", { fg = colors.selection, bg = colors.bright_yellow, bold = true })
  hl("LualineReplaceA", { fg = colors.bright_fg, bg = colors.red, bold = true })
  hl("LualineCommandA", { fg = colors.bright_fg, bg = colors.magenta, bold = true })
  hl("LualineInactive", { fg = colors.dim_fg, bg = colors.bg })
  ...
  hl("BufferLineCloseButton", { fg = colors.dim_fg, bg = colors.bg })
  hl("BufferLineCloseButtonSelected", { fg = colors.bright_fg, bg = colors.selection })
