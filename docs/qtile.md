...
The legacy Qtile network widget remains host-specific and is not part of the current desktop profile. Do not use it as a reference for the portable IWD/systemd-networkd configuration.
